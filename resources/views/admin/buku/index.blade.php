                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            <button id="bulk-delete-btn" style="display: none;" onclick="bulkDelete()" class="inline-flex items-center px-4 py-2.5 bg-rose-600 border border-transparent rounded-lg font-bold text-xs text-white uppercase tracking-widest hover:bg-rose-700 transition-all duration-300 shadow-lg shadow-rose-500/30">
                            ...
                            <div class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                                ...
                                <form id="export-form" action="{{ route('admin.buku.export') }}" method="GET" class="hidden">
                                ...
                                <form action="{{ route('admin.buku.import') }}" method="POST" enctype="multipart/form-data" class="hidden">
                                    @csrf
