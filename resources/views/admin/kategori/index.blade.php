                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <div class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                                ...
                                <form id="export-form" action="{{ route('admin.kategori.export') }}" method="GET" class="hidden">
                                ...
                                <form action="{{ route('admin.kategori.import') }}" method="POST" enctype="multipart/form-data" class="hidden">
                                    @csrf
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y-2 divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-bold text-indigo-600 dark:text-indigo-400 border-r-2 border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/20">{{ ($kategori->currentPage() - 1) * $kategori->perPage() + $loop->iteration }}</td>
