                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.kategori.store') }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <x-text-input id="nama_kategori" class="block mt-1 w-full bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 focus:border-indigo-500 rounded-xl transition-all" type="text" name="nama_kategori" :value="old('nama_kategori')" required autofocus placeholder="Masukkan nama kategori baru..." />
