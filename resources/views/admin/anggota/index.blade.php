                ...
                <form action="{{ route('admin.anggota.index') }}" method="GET" class="flex flex-col md:flex-row items-end gap-4">
                    <div class="w-full md:w-48">
                        ...
                        <select name="criteria" id="criteria" class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-all duration-300">
                            <option value="name" {{ request('criteria', 'name') == 'name' ? 'selected' : '' }}>Nama</option>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <div class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                                ...
                                <form id="export-form" action="{{ route('admin.anggota.export') }}" method="GET" class="hidden">
                                    <input type="hidden" name="ids" id="export-ids">
                                </form>
                                <div class="w-px h-4 bg-gray-300 dark:bg-gray-600 mx-1"></div>
                                <button onclick="document.getElementById('import-file').click()" class="inline-flex items-center px-3 py-1.5 text-xs font-bold text-gray-700 dark:text-gray-200 uppercase hover:bg-white dark:hover:bg-gray-600 rounded-md transition-all duration-300">
                                ...
                                <form action="{{ route('admin.anggota.import') }}" method="POST" enctype="multipart/form-data" class="hidden">
                                    @csrf
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y-2 divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-bold text-indigo-600 dark:text-indigo-400 border-r-2 border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/20">{{ ($anggota->currentPage() - 1) * $anggota->perPage() + $loop->iteration }}</td>
