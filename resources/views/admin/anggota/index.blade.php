                ...
                <form action="{{ route('admin.anggota.index') }}" method="GET" class="flex flex-col md:flex-row items-end gap-4">
                    ...
                    <div class="flex-1 w-full group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Cari data anggota..." class="block w-full pl-10 pr-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-all duration-300">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-2 w-full md:w-auto">
                        ...
                        @if(request()->anyFilled(['search', 'profil', 'criteria']))
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-100 dark:bg-gray-700/50">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 dark:text-gray-200 uppercase tracking-wider border-r-2 border-gray-200 dark:border-gray-700">Informasi Anggota</th>
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-16 text-center text-gray-500 dark:text-gray-400">
                                            <div class="flex flex-col items-center justify-center space-y-4">
                                                ...
                                                <span class="text-xl font-medium italic">Belum ada data anggota yang terdaftar.</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
    ...
    <script>
        function confirmDelete(id, name) {
            Swal.fire({
                ...
                html: `Apakah Anda yakin ingin menghapus anggota <b class="text-indigo-400">"${name}"</b>?`,
                icon: 'warning',
                background: '#1f2937',
                color: '#ffffff',
