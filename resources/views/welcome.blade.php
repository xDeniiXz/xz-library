    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-gray-100 dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex flex-col items-center justify-center">
                ...
                <h1 class="mt-8 text-5xl font-black text-gray-900 dark:text-white tracking-tighter uppercase">
            ...
            <div class="flex justify-center mt-24 px-0 sm:items-center sm:justify-between border-t border-gray-200 dark:border-gray-700 pt-8">
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left font-medium">
                    &copy; {{ date('Y') }} XZ <span class="text-indigo-600 dark:text-indigo-400 font-bold">Library</span>. All rights reserved.
                </div>

                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0 font-medium">
                    XZ <span class="text-indigo-600 dark:text-indigo-400 font-bold">Library</span> v1.0 (PHP v{{ PHP_VERSION }})
                </div>
            </div>
        </div>
    </div>
